#include<bits/stdc++.h>
#include<vector>
#include "ic.h" /*Libreria para las condiciones iniciales*/
#include "nrm.h" /*Libreria para el método Newton-Raphson*/
#include "ens.h" /*Libreria para el buscador eficiente de vecinos*/
#include "pk.h" /*Para el Kernel*/
#include "Dxx.h" /*Densidad*/
#include "Press.h" /*Presión*/
#include "Rtt.h" /*Aceleración*/
